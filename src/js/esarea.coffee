...
return if location.host.match(/qiita\.com|esa\.io|docbase\.io|pplog\.net|lvh\.me|slack\.com|mimemo\.io|kibe\.la|hackmd\.io|savanna\.io|scrapbox\.io|cosen\.se/)

selector = 'textarea:not([data-esarea-disabled="true"])'
